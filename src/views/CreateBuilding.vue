    ...
    <div v-else>
      ...
      <form @submit.prevent="createBuild">
        <div class="q-pa-md">
          ...
          <div v-else-if="data.type === types[3]">
            <div class="input-field-year">
              <label>Год постройки здания</label>
              <q-input outlined v-model.number="data.construction_year"
                       placeholder="гггг"
          ...
          <div v-else-if="data.type === types[4]">
            <div class="input-field-year">
              <label>Год постройки здания</label>
              <q-input outlined v-model.number="data.construction_year"
                       placeholder="гггг"
...
export default {
  data: () => ({
    types: ["Отдельно стоящее", "Встроенное в многоквартирный дом", "Пристроенное к многоквартирному дому", "Помещения в административном здании", "Помещения на территории ИТУ"],
