...
export default {
  ...
  data: () => ({
    ...
    columns: [
      ...
      {name: 'coolant_forward_temperature', align: 'center', label: 'Температура подающего трубопровода (℃)', field: 'coolant_forward_temperature', sortable: true},
      {name: 'coolant_backward_temperature', align: 'center', label: 'Температура обратного трубопровода (℃)', field: 'coolant_backward_temperature', sortable: true},
      {name: 'forward_pressure', align: 'center', label: 'Давление на подающем трубопроводе (кгс/см2)', field: 'forward_pressure', sortable: true},
      {name: 'backward_pressure', align: 'center', label: 'Давление на обратном трубопроводе (кгс/см2)', field: 'backward_pressure', sortable: true},
  ...
  methods: {
    ...
    async addTemperature() {
      ...
      const data = {
        ...
        coolant_forward_temperature: this.tempIn,
        coolant_backward_temperature: this.tempOut,
        forward_pressure: this.pressIn,
        backward_pressure: this.pressOut,
