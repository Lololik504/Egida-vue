    ...
    <div v-else>
      ...
      <form @submit.prevent="save">
        <div class="q-pa-md">
          ...
          <div v-if="organization === organizations[1]">
          ...
          <div class="select-type-field">
            ...
            <div class="select">
              <q-select outlined v-model="cable" :options="cables"/>
            </div>
          </div>
          <div v-if="cable === cables[11]">
          ...
          <div class="row">
            <div class="col">
              ...
              <q-input outlined type="number" v-model.number="fact_category"/>
            </div>
            <div class="col">
              <label>Требуемая</label>
              <q-input outlined type="number" v-model.number="need_category"/>
            </div>
          </div>
          <div class="select-type-field">
            <label>Наличие резервных источников электропитания</label>
            <div class="select">
              <q-select outlined v-model="reserve_source" :options="reserve_sources"/>
            </div>
          </div>
          <div class="input-field-roof-square">
            <label>Разрешенная мощность, кВт</label>
            <q-input outlined type="number" v-model.number="access_power"/>
          </div>
          <div class="select-type-field">
            <label>Наличие контура заземления</label>
            <div class="select">
              <q-select outlined v-model="contur" :options="conturs"/>
            </div>
          </div>
          <div class="input-field-roof-square">
            <label>Количество энергосберегающих ламп внутреннего освещения, шт</label>
            <q-input outlined type="number" v-model.number="count_inside_energy_lamp"/>
          </div>
          <div class="input-field-roof-square">
            <label>Количество ламп накаливания внутреннего освещения, шт</label>
            <q-input outlined type="number" v-model.number="count_inside_lamp"/>
          </div>
          <div class="input-field-roof-square">
            <label>Количество энергосберегающих ламп наружного освещения, шт</label>
            <q-input outlined type="number" v-model.number="count_side_energy_lamp"/>
          </div>
          <div class="input-field-roof-square">
            <label>Количество ламп накаливания наружного освещения, шт</label>
            <q-input outlined type="number" v-model.number="count_side_lamp"/>
          </div>
              ...
              <q-list>
                <q-item tag="label" v-ripple>
                  <q-item-section avatar top>
                    <q-radio v-model="status_inside" val="Работоспособное состояние"/>
                  </q-item-section>
                  <q-item-section>
                ...
                <q-item tag="label" v-ripple>
                  <q-item-section avatar top>
                    <q-radio v-model="status_inside" val="Ограниченно работоспособное состояние"/>
                  </q-item-section>
                  <q-item-section>
                ...
                <q-item tag="label" v-ripple>
                  <q-item-section avatar top>
                    <q-radio v-model="status_inside" val="Аварийное состояние"/>
                  </q-item-section>
                  <q-item-section>
          ...
          <q-card flat bordered class="my-card">
            ...
            <div class="q-pa-md">
              <q-list>
                <q-item tag="label" v-ripple>
                  <q-item-section avatar top>
                    <q-radio v-model="status_outside" val="Работоспособное состояние"/>
                  </q-item-section>
                  <q-item-section>
                    <q-item-label>Работоспособное состояние</q-item-label>
                    <q-item-label caption>категория технического состояния здания, при которой некоторые из численно
                ...
                <q-item tag="label" v-ripple>
                  <q-item-section avatar top>
                    <q-radio v-model="status_outside" val="Ограниченно работоспособное состояние"/>
                  </q-item-section>
                  <q-item-section>
                    <q-item-label>Ограниченно работоспособное состояние</q-item-label>
                    <q-item-label caption>категория технического состояния здания или его строительных конструкций,
                ...
                <q-item tag="label" v-ripple>
                  <q-item-section avatar top>
                    <q-radio v-model="status_outside" val="Аварийное состояние"/>
                  </q-item-section>
                  <q-item-section>
                    <q-item-label>Аварийное состояние</q-item-label>
                    <q-item-label caption>категория технического состояния строительной конструкции или здания и
...
export default {
  ...
  data: () => ({
    ...
    contur: null,
    count_inside_energy_lamp: null,
    count_side_energy_lamp: null,
    count_inside_lamp: null,
    count_side_lamp: null,
    status_outside: null,
    status_inside: null,
    act_inside: null,
    act_outside: null,
