      ...
      <form @submit.prevent="save">
        <div class="q-pa-md">
          <div class="input-field-roof-square">
            ...
            <q-input outlined :disable="disable" type="number" v-model="data.total_classroom_count"/>
          </div>
              ...
              <q-list>
                <q-item class="column">
                  ...
                  <div class="input-field-roof-square col">
                    ...
                    <q-input outlined type="number" :disable="disable" v-model="data.classroom_ok_count"/>
                  </div>
                </q-item>
                <q-item class="column">
                  ...
                  <div class="input-field-roof-square col">
                    <label>Количество помещений</label>
                    <q-input outlined type="number" :disable="disable" v-model="data.classroom_warning_count"/>
                  </div>
                </q-item>
                <q-item class="column">
                  ...
                  <div class="input-field-roof-square col">
                    <label>Количество помещений</label>
                    <q-input outlined type="number" :disable="disable" v-model="data.classroom_emergency_count"/>
                  </div>
                </q-item>
              </q-list>
            </div>
            <div v-if="!data.classroom_act" class="input-roof-photo" style="margin-left: 25px">
              <label>Акт обследования технического состояния (экспертной оценки специализированной организации)</label>
              <q-file
                  v-model="data.classroom_act"
                  outlined
                  :disable="disable"
            ...
            <div v-else style="margin-bottom: 25px; margin-left: 25px">
              ...
              <div class="q-gutter-sm">
                <button v-if="!changedAct" class="btn blue"
                        @click.prevent="showDoc(data.classroom_act)">
                  Просмотреть файл
                </button>
...
export default {
  ...
  data: () => ({
    ...
    data: {
      ...
      classroom_ok_count: null,
      classroom_warning_count: null,
      classroom_emergency_count: null,
      classroom_act: null,
    },
    loading: true,
  }),
    ...
    async save() {
      try {
        ...
        for (let key in this.data) {
          if (key === 'classroom_act' && typeof this.data[key] === 'string') {
            continue
          }
