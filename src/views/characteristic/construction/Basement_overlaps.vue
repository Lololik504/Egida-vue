      ...
      <form @submit.prevent="save">
        <div class="q-pa-md">
          <div class="select-type-field">
            ...
            <div class="select">
              <q-select outlined :disable="disable" v-model="data.basement_overlapping_material" :options="overlap_materials"/>
            </div>
          </div>
          ...
          <q-card flat bordered class="my-card">
            ...
            <div class="q-pa-md">
              <q-list>
                ...
                <q-item tag="label" v-ripple>
                  <q-item-section avatar top>
                    <q-radio :disable="disable" v-model="data.basement_overlapping_status" val="Работоспособное состояние"/>
                  </q-item-section>
                  <q-item-section>
                ...
                <q-item tag="label" v-ripple>
                  <q-item-section avatar top>
                    <q-radio :disable="disable" v-model="data.basement_overlapping_status" val="Ограниченно работоспособное состояние"/>
                  </q-item-section>
                  <q-item-section>
                ...
                <q-item tag="label" v-ripple>
                  <q-item-section avatar top>
                    <q-radio :disable="disable" v-model="data.basement_overlapping_status" val="Недопустимое состояние"/>
                  </q-item-section>
                  <q-item-section>
