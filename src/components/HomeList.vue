<template>
  <div class="list">
    ...
    <router-link v-if="getPermission > 10" class="list-item" :to="`/schoolcard/${getInn}`">Ежедневные параметры теплоносителя и внутреннего воздуха помещений</router-link>
    <router-link v-else class="list-item" :to="'/districts'">Ежедневные параметры теплоносителя и внутреннего воздуха помещений</router-link>
